...
class employeeController {
    ...
    private $required = array('name', 'games_sold', 'time_working', 'games_rented', 'workplace_ID', 'manager_ID');
    ...
    public function createAction() {
        ...
        if ($data) {
            ...
            $latestId = employee::getMaxIdOfEmployee();
            // Increment it by one
            $data['id'] = $latestId + 1;
    ...
    public function deleteAction() {
        ...
        // šaliname markę
        $err = (employee::deleteEmployee($id)) ? '' : 'delete_error=1';
