m<?php require('header.php'); ?>
<ul id="pagePath">
	<li><a href="<?php echo routing::getURL(); ?>">Pradžia</a></li>
	<li><a href="<?php echo routing::getURL($module); ?>">Darbuotojai</a></li>
			...
			<legend>Darbuotojo informacija</legend>
				<p>
					...
					<?php } else { ?>
						...
						<input type="text" id="tabelio_nr" name="tabelio_nr" class="textbox-150 hidden" value="<?php echo isset($fields['tabelio_nr']) ? $fields['tabelio_nr'] : ''; ?>" />
					<?php } ?>
				</p>
			<p>
